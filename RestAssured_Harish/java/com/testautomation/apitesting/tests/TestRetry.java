...
public class TestRetry extends BaseTest {
	...
	private static final Logger logger = LogManager.getLogger(TestRetry.class);
	...
	public void e2eAPIRequest() {
		...
		try {
			...
			.withMaxRetries(5)
			.onRetry(e->logger.info("First name is not matching..."))
			.onFailure(e->logger.info("First name is not matched"))
			.build();
	...
	public void e2eAPIRequest2() {
		System.out.println("e2eAPIRequest2 is running..");
	}
	
	@Test
	public void e2eAPIRequest3() {
		System.out.println("e2eAPIRequest3 is running..");
	}
